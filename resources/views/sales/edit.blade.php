...
@section('content')
    ...
    <div class="form-group">
        ...
        {{form::Number('quantity',$sales->bprice,['class' =>'form-control','placeholder'=>'Buying Price'])}}
    </div>

    <div class="form-group">
        <!--This is for the number of products being sold-->
        {{form::label('Selling Price','Selling Price')}}
        {{form::Number('sprice',$sales->sprice,['class' =>'form-control','placeholder'=>'Selling Price'])}}
    </div>
